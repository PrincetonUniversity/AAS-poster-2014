...
the gravitationally focused wind reaches a quasi-stationary state.  The stellar
wind produced by the AGB star is deflected towards the secondary within the
...
the AGB star in the rotating reference frame of the binary system.  The
